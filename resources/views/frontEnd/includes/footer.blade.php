<div class="footer">
    <div class="container">
        <div class="col-md-3 footer-left">
            <h2><a href="index.html"><img src="{{('/frontEnd/images/')}}/logo3.jpg" alt=" " /></a></h2>
        ...
        <div class="col-md-9 footer-right">
            ...
            <div class="sign-grds">
                ...
                <div class="col-md-4 sign-gd flickr-post">
                    <h4>Flickr Posts</h4>
                    <ul>
                        <li><a href="single.html"><img src="{{('/frontEnd/images/')}}/b15.jpg" alt=" "
                                    class="img-responsive" /></a>
                        </li>
                        <li><a href="single.html"><img src="{{('/frontEnd/images/')}}/b16.jpg" alt=" "
                                    class="img-responsive" /></a>
                        </li>
                        <li><a href="single.html"><img src="{{('/frontEnd/images/')}}/b17.jpg" alt=" "
                                    class="img-responsive" /></a>
                        </li>
                        <li><a href="single.html"><img src="{{('/frontEnd/images/')}}/b18.jpg" alt=" "
                                    class="img-responsive" /></a>
                        </li>
                        <li><a href="single.html"><img src="{{('/frontEnd/images/')}}/b15.jpg" alt=" "
                                    class="img-responsive" /></a>
