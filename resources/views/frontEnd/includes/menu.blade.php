                    ...
                    <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav menu__list">
                            <li class="active menu__item menu__item--current">
                                <a class="menu__link" href="{{url('/')}}">Home <span class="sr-only">(current)</span></a></li>

                                @foreach ($publishedCategories as $publishedCategory)
                                    <li class="dropdown menu__item">
                                <a href="{{ url('/category-View'.$publishedCategory->id) }}" class="dropdown-toggle menu__link" >{{ $publishedCategory->categoryName }} <span
                                        class="caret"></span></a>
                                @endforeach
                                ...
                                <ul class="dropdown-menu multi-column columns-3">
                                    <div class="row">
                                        <div class="col-sm-6 multi-gd-img1 multi-gd-text ">
                                            <a href="mens.html"><img src="{{('/frontEnd/images/')}}/woo1.jpg"
                                                    alt=" " /></a>
                                        </div>
                                ...
                                <ul class="dropdown-menu multi-column columns-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 multi-gd-img multi-gd-text ">
                                            <a href="womens.html"><img src="{{('/frontEnd/images/')}}/woo.jpg"
                                                    alt=" " /></a>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
