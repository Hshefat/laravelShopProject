		...
		<div class="col-md-8 products-right">
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						<li>
							<img class="img-responsive" src="{{('/frontEnd/images/')}}/men1.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{('/frontEnd/images/')}}/men2.jpg" alt=" "/>
						</li>
						<li>
							<img class="img-responsive" src="{{('/frontEnd/images/')}}/men1.jpg" alt=" "/>
						</li>
			...
			<div class="men-wear-bottom">
				<div class="col-sm-4 men-wear-left">
					<img class="img-responsive" src="{{('/frontEnd/images/')}}/men3.jpg" alt=" " />
				</div>
				...
				<div class="col-md-4 product-men no-pad-men">
					<div class="men-pro-item simpleCart_shelfItem">
						<div class="men-thumb-item">
							<img src="{{('/frontEnd/images/')}}/a2.png" alt="" class="pro-image-front">
							<img src="{{('/frontEnd/images/')}}/a2.png" alt="" class="pro-image-back">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
		...
		<div class="single-pro">
			...
			<div class="col-md-3 product-men">
				<div class="men-pro-item simpleCart_shelfItem">
					...
					<div class="item-info-product ">
						<h4><a href="single.html">{{asset($publishedCategoryProduct->productName)}}</a></h4>
						<div class="info-product-price">
							<span class="item_price">{{asset($publishedCategoryProduct->productPrice)}}</span>
							<del>$69.71</del>
						</div>
						<a href="#" class="item_add single-item hvr-outline-out button2">Add to cart</a>
					</div>
